...
const Highlight = ({ifExists, endpoint: {title, heading, text, img, btn}}) => {
  return (
    <>
      <div className={`flex items-center justify-between pt-8 pb-20 lg:flex-col lg:justify-center
        nike-container ${ifExists ? 'flex-row-reverse' : 'flex-row'}`}>
        <div className='max-w-lg lg:max-w-none w-full p-8 md:text-center grid items-center 
        ...
        <div className='flex items-center justify-center max-w-xl p-8 relative lg:max-w-none w-full'>
